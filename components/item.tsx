...
export default function Item({ title, id, children }: ItemProps) {
	return <label htmlFor={id} className="w-full hover:bg-accent transition-all py-3 px-2 rounded-md  gap-4 grid grid-cols-3 items-center has-checked:bg-accent">
